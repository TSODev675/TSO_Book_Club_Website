  ...
  return (
    <>
      <div className="py-16 px-8 text-center" style={{ background: 'var(--csir-navy)' }}>
        ...
        <a href="/register" className="inline-block px-8 py-3 rounded-lg text-sm font-medium transition hover:bg-blue-50" style={{ background: 'white', color: 'var(--csir-navy)' }}>
          Join Book Club →
        </a>
      </div>
      <footer className="px-8 py-4 flex items-center justify-between" style={{ background: 'var(--csir-navy-dark)' }}>
        ...
        <div className="flex gap-4">
          ...
          <a href="#" className="text-xs text-white/40 hover:text-white/70 transition">Contact</a>
        </div>
      </footer>
    </>
  )
